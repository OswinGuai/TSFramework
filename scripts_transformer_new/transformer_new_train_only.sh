...
# --testset_csv_path /workspace/qiuyunzhong/TSFrameworkData/alumina_testset.csv \
# --datetime_col dtime \
...
--stage train_only 
--model_id alumina_transformer_new_train_only
--model_name alumina_transformer_new
--log_path log 
--trainset_csv_path /workspace/qiuyunzhong/TSFrameworkData/alumina_trainset.csv 
--validset_csv_path /workspace/qiuyunzhong/TSFrameworkData/alumina_validset.csv
