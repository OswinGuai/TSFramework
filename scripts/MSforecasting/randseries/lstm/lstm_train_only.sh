...
#     --stage train_only 
#     --model_id alumina_lstm
#     --model_name alumina_lstm 
#     --task_name MS
#     --log_path log 
...
#     --gpu 0 
#     --use_nni
#     --checkpoints ./checkpoints/alumina_lstm_train_only
#     --hidden_dim 128
#     --d_model 128
#     --e_layers 1
#     --d_layers 1
...
checkpoints_path="./checkpoints/randseries/lstm"
...
cmd1="python -u main_nni.py 
    ...
    --testset_csv_path /workspace/qiuyunzhong/TSFrameworkData/alumina_testset_new.csv 
    --datetime_col dtime 
    --feature_cols Rand0,Rand1,Rand2,Rand3,Rand4,Rand5,Rand6,Rand7,Rand8,Rand9,1效蒸发器汽温
    --target_cols 1效蒸发器汽温
    --seq_len 30 
    --label_len 2 
    --pred_len 30
...
cmd2="python -u main_nni.py 
    ...
    --testset_csv_path /workspace/qiuyunzhong/TSFrameworkData/alumina_testset_new.csv 
    --datetime_col dtime 
    --feature_cols Rand0,Rand1,Rand2,Rand3,Rand4,Rand5,Rand6,Rand7,Rand8,Rand9,1效蒸发器汽室压力
...
cmd3="python -u main_nni.py 
    ...
    --testset_csv_path /workspace/qiuyunzhong/TSFrameworkData/alumina_testset_new.csv 
    --datetime_col dtime 
    --feature_cols Rand0,Rand1,Rand2,Rand3,Rand4,Rand5,Rand6,Rand7,Rand8,Rand9,1效原液换热前温度
...
cmd4="python -u main_nni.py 
    ...
    --testset_csv_path /workspace/qiuyunzhong/TSFrameworkData/alumina_testset_new.csv 
    --datetime_col dtime 
    --feature_cols Rand0,Rand1,Rand2,Rand3,Rand4,Rand5,Rand6,Rand7,Rand8,Rand9,1效出料温度
    --target_cols 1效出料温度
    --seq_len 30 
    --label_len 2 
    --pred_len 30
