...
if __name__ == "__main__":
    Q = torch.randn(128, 96, 8, 64, requires_grad=True).to(device='cuda')
    K = torch.randn(128, 96, 8, 64, requires_grad=True).to(device='cuda')
    V = torch.randn(128, 96, 8, 64, requires_grad=True).to(device='cuda')
